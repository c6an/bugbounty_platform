...
$allow_types = ['xss','sqlli','openredirection','IDOR','RCE','LFI'];
...
$sql = "INSERT INTO report
        (user_name, report_title, endpoint, url, vuln_type, poc, report_date)
        VALUES (?, ?, ?, ?, ?, ?, CURDATE())";
$stmt = $db_conn->prepare($sql);
$stmt->bind_param("ssssss", $user_name, $title, $endpoint, $url, $vuln_type, $poc_md);
$ok = $stmt->execute();
